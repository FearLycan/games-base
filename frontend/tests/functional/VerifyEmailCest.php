...
class VerifyEmailCest
{
    ...
    {
        $I->amOnRoute('user/auth/verify-email', ['token' => '']);
    ...
    {
        $I->amOnRoute('user/auth/verify-email', ['token' => 'wrong_token']);
        $I->canSee('Bad Request', 'h1');
    ...
    {
        $I->amOnRoute('user/auth/verify-email');
        $I->canSee('Bad Request', 'h1');
    ...
    {
        $I->amOnRoute('user/auth/verify-email', ['token' => 'already_used_token_1548675330']);
        $I->canSee('Bad Request', 'h1');
        $I->canSee('Wrong verify email token.');
    }
    ...
    {
        $I->amOnRoute('user/auth/verify-email', ['token' => '4ch0qbfhvWwkcuWqjN8SWRq72SOw1KYT_1548675330']);
