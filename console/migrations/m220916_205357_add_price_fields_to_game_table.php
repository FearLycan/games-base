...
class m220916_205357_add_price_fields_to_game_table extends Migration
{
    ...
    {
        $this->addColumn('{{%game}}', 'steam_price_initial', $this->integer()->defaultValue(0)->after('steam_appid'));
        $this->addColumn('{{%game}}', 'steam_price_final', $this->integer()->defaultValue(0)->after('steam_price_initial'));
