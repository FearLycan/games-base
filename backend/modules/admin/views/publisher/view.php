...
/* @var $controller backend\modules\admin\controllers\PublisherController */

$this->title = (string)$model->name ?: ('Publisher #' . $model->id);
...
<div class="admin-page-header">
    ...
    <div class="d-flex gap-2">
        ...
        <?= Html::a('<i class="bi bi-trash"></i> Delete', ['delete', 'id' => $model->id], [
            ...
            'data'  => ['confirm' => 'Delete this publisher permanently?', 'method' => 'post'],
        ]) ?>
    </div>
</div>
...
<section class="offer-panel">
    ...
    <?php if ($games): ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <p class="text-muted mb-0">No games linked to this publisher.</p>
    <?php endif; ?>
</section>
