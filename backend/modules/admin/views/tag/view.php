...
/* @var $controller backend\modules\admin\controllers\TagController */

$this->title = (string)$model->name ?: ('Tag #' . $model->id);
...
<div class="admin-page-header">
    ...
    <div class="d-flex gap-2">
        ...
        <?= Html::a('<i class="bi bi-trash"></i> Delete', ['delete', 'id' => $model->id], [
            ...
            'data'  => ['confirm' => 'Delete this tag permanently?', 'method' => 'post'],
        ]) ?>
    </div>
</div>
...
<section class="offer-panel">
    <h2 class="offer-panel__title">Games with this tag</h2>
    <?php if ($games): ?>
        ...
        <?php if (count($games) >= 24): ?>
            <p class="text-muted small mt-2 mb-0">Showing first 24.</p>
        <?php endif; ?>
    <?php else: ?>
        <p class="text-muted mb-0">No games linked to this tag.</p>
    <?php endif; ?>
</section>
