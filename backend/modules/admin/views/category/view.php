...
/* @var $controller backend\modules\admin\controllers\CategoryController */

$this->title = (string)$model->name ?: ('Category #' . $model->id);
...
<div class="admin-page-header">
    ...
    <div class="d-flex gap-2">
        ...
        <?= Html::a('<i class="bi bi-trash"></i> Delete', ['delete', 'id' => $model->id], [
            ...
            'data'  => ['confirm' => 'Delete this category permanently?', 'method' => 'post'],
        ]) ?>
    </div>
</div>
...
<div class="offer-grid">
    ...
    <section class="offer-panel">
        ...
        <dl class="offer-dl">
            <dt>Name</dt>
            <dd><?= Html::encode((string)$model->name) ?></dd>
            <dt>Slug</dt>
            <dd class="text-muted"><?= Html::encode((string)$model->slug) ?: '—' ?></dd>
            <dt>Status</dt>
            <dd><?= AdminHtml::activePill((int)$model->status) ?></dd>
            <dt>Games</dt>
            <dd><?= number_format((int)$model->games_count) ?></dd>
            <dt>Created</dt>
            <dd class="text-muted"><?= Html::encode((string)$model->created_at) ?></dd>
            <dt>Updated</dt>
            <dd class="text-muted"><?= Html::encode((string)($model->updated_at ?? '—')) ?></dd>
        </dl>
...
<section class="offer-panel">
    <h2 class="offer-panel__title">Games in this category <span class="text-muted">(<?= number_format((int)$model->games_count) ?>)</span></h2>
    <?php if ($games): ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <p class="text-muted mb-0">No games linked to this category.</p>
    <?php endif; ?>
</section>
